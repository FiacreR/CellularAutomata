...
function applyRule() {
    for (let x = 1; x < (width/spacer)-1; x++) {
        if((alive[x-1][1]==1)&&(alive[x][1]==1)&&(alive[x+1][1]==1)) {alive[x][0] = rule[0]}
        if((alive[x-1][1]==1)&&(alive[x][1]==1)&&(alive[x+1][1]==0)) {alive[x][0] = rule[1]}
        if((alive[x-1][1]==1)&&(alive[x][1]==0)&&(alive[x+1][1]==1)) {alive[x][0] = rule[2]}
        if((alive[x-1][1]==1)&&(alive[x][1]==0)&&(alive[x+1][1]==0)) {alive[x][0] = rule[3]}
        if((alive[x-1][1]==0)&&(alive[x][1]==1)&&(alive[x+1][1]==1)) {alive[x][0] = rule[4]}
        if((alive[x-1][1]==0)&&(alive[x][1]==1)&&(alive[x+1][1]==0)) {alive[x][0] = rule[5]}
        if((alive[x-1][1]==0)&&(alive[x][1]==0)&&(alive[x+1][1]==1)) {alive[x][0] = rule[6]}
        if((alive[x-1][1]==0)&&(alive[x][1]==0)&&(alive[x+1][1]==0)) {alive[x][0] = rule[7]}
    }
    // x = 0  
